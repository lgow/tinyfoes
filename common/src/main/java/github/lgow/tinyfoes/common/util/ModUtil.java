...
import static github.lgow.tinyfoes.common.registry.ModEffects.BABYFICATION_POTION;
...
public class ModUtil {
	...
	public final static List<Item> TAB_EGG_LIST = List.of(Items.BLAZE_SPAWN_EGG, Items.CREEPER_SPAWN_EGG,
			Items.CAVE_SPIDER_SPAWN_EGG, Items.ENDERMAN_SPAWN_EGG, Items.EVOKER_SPAWN_EGG, Items.GHAST_SPAWN_EGG, Items.IRON_GOLEM_SPAWN_EGG,
			Items.PHANTOM_SPAWN_EGG, Items.PIGLIN_BRUTE_SPAWN_EGG, Items.PILLAGER_SPAWN_EGG, Items.RAVAGER_SPAWN_EGG,
			Items.SKELETON_SPAWN_EGG, Items.SNOW_GOLEM_SPAWN_EGG, Items.SPIDER_SPAWN_EGG, Items.STRAY_SPAWN_EGG, Items.VINDICATOR_SPAWN_EGG,
