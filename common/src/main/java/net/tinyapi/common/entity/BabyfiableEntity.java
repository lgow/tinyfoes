package net.tinyapi.common.entity;
...
public interface BabyfiableEntity {
	...
	default void tinyapi$$setBabyfied(boolean b) {
	}

	default void tinyapi$$setBaby(boolean b) {
	}

	default boolean tinyapi$$isBabyfied() {
		return false;
	}

	default boolean tinyapi$$isBaby() {
		return false;
	}
}
