...
public class ModUtil {
	...
	public final static NonNullList<Item> TAB_ITEM_LIST = NonNullList.of(null, ModItems.BABYFIER.get().asItem(),
			Items.BLAZE_SPAWN_EGG, Items.CREEPER_SPAWN_EGG, Items.PHANTOM_SPAWN_EGG, Items.CAVE_SPIDER_SPAWN_EGG,
			Items.ENDERMAN_SPAWN_EGG, Items.EVOKER_SPAWN_EGG, Items.GHAST_SPAWN_EGG, Items.PIGLIN_BRUTE_SPAWN_EGG,
