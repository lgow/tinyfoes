...
public class TinyAlliesExpectPlatform {
	 ...
	 * <p>
	 * Example: Expect: net.tinyallies.ExampleExpectPlatform#getConfigDirectory() Actual Fabric:
	 * net.tinyallies.fabric.ExampleExpectPlatformImpl#getConfigDirectory() Actual Forge:
	 * net.tinyallies.forge.ExampleExpectPlatformImpl#getConfigDirectory()
	 * <p>
