package com.lgow.endofherobrine.entity.herobrine;//todo teleport to nearest player, hold best weapon and equip best armor
...
//todo player quits game doppleganger disappears
    ...
    public Doppelganger(EntityType<? extends Doppelganger> type, Level level) { super(type, level);}

    public AbstractClientPlayer getClientPlayer() { return (AbstractClientPlayer) getTargetPlayer();}

    public ServerPlayer getServerPlayer(){ return (ServerPlayer) getTargetPlayer();}
    ...
    public HumanoidArm getMainArm() {
        if(getTargetPlayer() != null){
            return this.getTargetPlayer().getMainArm();
        } else {
    ...
    public boolean doHurtTarget(Entity target) {
        if(target instanceof ServerPlayer serverPlayer && !hasPlayerUUID()) {
            ...
            this.setTargetPlayer((Player) target);
