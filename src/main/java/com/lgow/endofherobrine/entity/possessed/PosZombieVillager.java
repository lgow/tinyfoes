...
public class PosZombieVillager extends ZombieVillager {
    ...
    @Override
    protected ResourceLocation getDefaultLootTable() { return new ResourceLocation("minecraft", "entities/zombie_villager");}
